    ...
    <el-card shadow="never">
      ...
      <div class="choose">
        <div class="citrusPart">
          <span>疾病部位:</span>
          <el-select size="small" @change="getCatalogue()" style="margin-left: 10px" placeholder="请选择" v-model="searchInfo.citrusPartId">
            <el-option v-for="part in partOptions" :key="part.value" :label="part.label" :value="part.value"> </el-option>
          </el-select>
        </div>
        <div class="disasterType">
          <span>疾病类型:</span>
          <el-select size="small" @change="getCatalogue()" style="margin-left: 10px" placeholder="请选择" v-model="searchInfo.disasterTypeId">
